...
//        if (!isset($options['idehweb_default_gateways'])) $options['idehweb_default_gateways'] = '';
        ...
        wp_enqueue_script('idehweb-lwp-validate-script', plugins_url('/scripts/jquery.validate.js', dirname(__FILE__)), array('jquery'), '1.8.50', true);


        wp_enqueue_script('idehweb-lwp', plugins_url('/scripts/login-with-phonenumber.js', dirname(__FILE__)), array('jquery'), '1.8.50', true);


        if ($options['idehweb_use_custom_gateway'] == '1' && in_array('firebase', $options['idehweb_default_gateways'])) {
            wp_enqueue_script('lwp-firebase', plugins_url('/scripts/firebase/firebase-app.js', dirname(__FILE__)), array(), '1.8.50', true);
            wp_enqueue_script('lwp-firebase-auth', plugins_url('/scripts/firebase//firebase-auth.js', dirname(__FILE__)), array(), '1.8.50', true);
            wp_enqueue_script('lwp-firebase-sender', plugins_url('/scripts/firebase-sender.js', dirname(__FILE__)), array('jquery'), '1.8.50', true);
